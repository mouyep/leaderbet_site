                    ...
                    <div class="carousel-header carousel slide col-md-offset-2 col-md-8 col-sm-8">
                        ...
                        <div id="carousel" class="carousel slide">
                            ...
                            <div class="carousel-inner">
                                ...
                                <div class="item">
                                    <p class="info_header3">En cas de soucis contactez le 00237690000000</p>
                                </div>
                                <div class="item">
                                    <p class="info_header4">LeaderBet le numéro1 dans le paris hippique au cameroun</p>
                                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-10 col-lg-offset-2">
                            ...
                            <div class="row" id="commentaire">
                                ...
                                <h3>LE COMMENTAIRE DE L'EXPERT</h3>
                                <P class="col-lg-offset-2 col-lg-10 col-md-10">
