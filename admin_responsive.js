    ...
    $('input[type=button].save_').on({
        ...
        'click': function(e){
            ...
            if(check_required_fields() && tab_retour[0]){
                ...
                xhr.open('POST', 'https://prono.leaderbet.cm/traitement.php');
...
function load_recent_prono(){
    ...
    setInterval(function(){
        ...
        var xhr = new XMLHttpRequest();
        xhr.open('POST', 'https://prono.leaderbet.cm/refresh.php');
    ...
    $('.list_prono tbody tr').each(function(){
        ...
        $(this).children('td').eq(15).on({
            ...
            'click': function(e){
                ...
                $('#update_prono > div > div > .modal-body > .prono_zone > .arrivee input:text').val($(this).parent().children('td').eq(10).text());
...
function get_and_set_Info_prono(id_prono,
    ...
    var myNamespace = {
        ...
        xhr.open('POST', 'https://prono.leaderbet.cm/infoprono.php');
        xhr.send(data_to_send);
